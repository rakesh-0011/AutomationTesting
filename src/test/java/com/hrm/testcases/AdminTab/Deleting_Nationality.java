...
public class Deleting_Nationality extends TestBase{
	...
	TopNevigationMenuPage topnevigationmenupage;
		...
		@Test(description="HRMS-32:Deleting Nationality")
		public void DeletingNAtionality() {
			try {
			    Log.startTestCase("-------Functionality of Deleting Nationality-----------");
			    ...
			    usermgmtpage.deleting_nationality("Afgan");
			    Log.info("Nationality Deleted Successfully");
			    Assert.assertEquals(true, usermgmtpage.DeleteNationalitySuccess());
