...
public class AddingEmploymentStatus extends TestBase{
	...
	TopNevigationMenuPage topnevigationmenupage;
		...
		@Test(description="HRMS-125:Adding Employment Status in Job Section")
		public void AddingEmploymentstatus() {
			try {
			    Log.startTestCase("-------Functionality of Adding Employment Status in Job Section-----------");
			    ...
			    usermgmtpage.addingEmployment("Employee");
			    Log.info("Employment Status Added Successfully");
			    Assert.assertEquals(true, usermgmtpage.AddEmploymentSuccess());
