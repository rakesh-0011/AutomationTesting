...
public class SearchLocationFunctionality extends TestBase{
	...
	TopNevigationMenuPage topnevigationmenupage;
		...
		@Test(description="HRMS-37:Search for Locations in Organization section")
		public void SearchLocation() {
			try {
			    Log.startTestCase("-------Functionality of Searching Location in Organization Section-----------");
			    ...
			    usermgmtpage.search_location("chennai");
			    Log.info("Location found");
			    Assert.assertEquals(true, usermgmtpage.Search_LocationSuccess());
