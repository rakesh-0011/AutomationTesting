...
public class DeletingSkill extends TestBase{
	...
	TopNevigationMenuPage topnevigationmenupage;
		...
		@Test(description="HRMS-119:Delete added skill in Qualifiaction section")
		public void DeleteSkill() {
			try {
			    Log.startTestCase("-------Functionality of Deleting Skills in Qualification Section-----------");
			    ...
			    usermgmtpage.deleteSkills("Test architecture");
			    Log.info("Work Skill Deleted Successfully");
			    Assert.assertEquals(true, usermgmtpage.DeletingSkillSuccess());
