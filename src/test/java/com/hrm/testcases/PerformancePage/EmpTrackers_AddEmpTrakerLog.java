...
public class EmpTrackers_AddEmpTrakerLog extends TestBase {
	LoginPage loginPage;
	...
	@Test(description="HRMS-102:Verify Functionality of Employee Trackers")
	public void AddEmpTrakerLog (){
		try{
